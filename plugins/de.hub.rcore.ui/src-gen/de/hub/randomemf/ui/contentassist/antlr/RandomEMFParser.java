...
* generated by Xtext
*/
package de.hub.randomemf.ui.contentassist.antlr;
...
public class RandomEMFParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.hub.randomemf.ui.contentassist.antlr.internal.InternalRandomEMFParser createParser() {
		de.hub.randomemf.ui.contentassist.antlr.internal.InternalRandomEMFParser result = new de.hub.randomemf.ui.contentassist.antlr.internal.InternalRandomEMFParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGeneratorAccess().getGroup_0(), "rule__Generator__Group_0__0");
					put(grammarAccess.getAlternativeRuleAccess().getGroup(), "rule__AlternativeRule__Group__0");
					put(grammarAccess.getAlternativeRuleAccess().getGroup_2(), "rule__AlternativeRule__Group_2__0");
					put(grammarAccess.getAlternativeRuleAccess().getGroup_2_2(), "rule__AlternativeRule__Group_2_2__0");
					put(grammarAccess.getAlternativeRuleAccess().getGroup_7(), "rule__AlternativeRule__Group_7__0");
					put(grammarAccess.getAlternativeAccess().getGroup(), "rule__Alternative__Group__0");
					put(grammarAccess.getAlternativeAccess().getGroup_2(), "rule__Alternative__Group_2__0");
					put(grammarAccess.getClassRuleAccess().getGroup(), "rule__ClassRule__Group__0");
					put(grammarAccess.getClassRuleAccess().getGroup_1(), "rule__ClassRule__Group_1__0");
					...
					put(grammarAccess.getGeneratorAccess().getPackageAssignment_0_1(), "rule__Generator__PackageAssignment_0_1");
					put(grammarAccess.getGeneratorAccess().getImportSectionAssignment_1(), "rule__Generator__ImportSectionAssignment_1");
					put(grammarAccess.getGeneratorAccess().getNameAssignment_3(), "rule__Generator__NameAssignment_3");
					put(grammarAccess.getGeneratorAccess().getEcorePackageAssignment_5(), "rule__Generator__EcorePackageAssignment_5");
					put(grammarAccess.getGeneratorAccess().getImportURIAssignment_7(), "rule__Generator__ImportURIAssignment_7");
					put(grammarAccess.getGeneratorAccess().getRulesAssignment_9(), "rule__Generator__RulesAssignment_9");
					put(grammarAccess.getAlternativeRuleAccess().getNameAssignment_1(), "rule__AlternativeRule__NameAssignment_1");
					put(grammarAccess.getAlternativeRuleAccess().getParamsAssignment_2_1(), "rule__AlternativeRule__ParamsAssignment_2_1");
					put(grammarAccess.getAlternativeRuleAccess().getParamsAssignment_2_2_1(), "rule__AlternativeRule__ParamsAssignment_2_2_1");
					put(grammarAccess.getAlternativeRuleAccess().getEClassAssignment_4(), "rule__AlternativeRule__EClassAssignment_4");
					put(grammarAccess.getAlternativeRuleAccess().getInnersAssignment_6(), "rule__AlternativeRule__InnersAssignment_6");
					put(grammarAccess.getAlternativeRuleAccess().getInnersAssignment_7_1(), "rule__AlternativeRule__InnersAssignment_7_1");
					put(grammarAccess.getAlternativeAccess().getExprAssignment_1(), "rule__Alternative__ExprAssignment_1");
					put(grammarAccess.getAlternativeAccess().getNumberAssignment_2_1(), "rule__Alternative__NumberAssignment_2_1");
					put(grammarAccess.getClassRuleAccess().getNameAssignment_0(), "rule__ClassRule__NameAssignment_0");
					put(grammarAccess.getClassRuleAccess().getParamsAssignment_1_1(), "rule__ClassRule__ParamsAssignment_1_1");
					put(grammarAccess.getClassRuleAccess().getParamsAssignment_1_2_1(), "rule__ClassRule__ParamsAssignment_1_2_1");
					put(grammarAccess.getClassRuleAccess().getEClassAssignment_3(), "rule__ClassRule__EClassAssignment_3");
					put(grammarAccess.getClassRuleAccess().getInnersAssignment_5(), "rule__ClassRule__InnersAssignment_5");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.hub.randomemf.ui.contentassist.antlr.internal.InternalRandomEMFParser typedParser = (de.hub.randomemf.ui.contentassist.antlr.internal.InternalRandomEMFParser) parser;
			typedParser.entryRuleGenerator();
