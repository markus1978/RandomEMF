...
public class RandomEMFSyntacticSequencer extends AbstractSyntacticSequencer {

	protected RandomEMFGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (RandomEMFGrammarAccess) access;
