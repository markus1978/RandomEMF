 ...
 * 
 * Code found at http://forum.codecall.net/topic/49665-java-random-name-generator/, modified
 * 
...
public class NameGenerator {
     ...
     * @throws IOException
     */
    public NameGenerator(String fileContents, RandomEngine rand) throws IOException{
    ...
    public void init() throws IOException{
        ...
        input = new ByteArrayInputStream(fileContents.getBytes());
    ...
    private String rupper(String s){
    ...
    public String compose(int syls){
        ...
        String name;
        int a = (int)(rand.nextFloat() * pre.size());
        ...
        for(int i = 0; i<b.length-2; i++){
            ...
            do{
                b[i] = (int)(rand.nextFloat() * mid.size());
        ...
        for(int i = 0; i<b.length-2; i++){
            name = name.concat(rupper(pureSyl(mid.get(b[i]).toLowerCase())));            
        }
        if(syls > 1)
            name = name.concat(rupper(pureSyl(sur.get(c).toLowerCase())));
        return name;        
    }    
}
