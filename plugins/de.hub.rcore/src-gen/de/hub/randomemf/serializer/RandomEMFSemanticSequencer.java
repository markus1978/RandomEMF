package de.hub.randomemf.serializer;
...
public class RandomEMFSemanticSequencer extends XbaseSemanticSequencer {
	 ...
	 * Constraint:
	 *     (
	 *         eFeature=[EStructuralFeature|ID] 
	 *         concreteValueType=[EClass|ID]? 
	 *         isAddRule?='+='? 
